...
def get_embeddings(embeddings_name):
    return TransformerWordEmbeddings(embeddings_name, fine_tune=False)
...
def main():
    ...
    parser.add_argument('--embeddings', type=str, default='bert-base-uncased')
    # CRF or softmax
    ...
    run: Run = wandb.init(project="truecaser", group="transformers")

    wandb.config.update(args)
    wandb.config.fine_tune = False
