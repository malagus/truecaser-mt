...
from training_utils import Result
...
class SequenceTagger(flair.nn.Model):
    ...
    def evaluate(
        ...
        classification_report = metrics.classification_report(y_true, y_pred, digits=4, target_names=target_names,
                                                              zero_division=1)
        classification_report2 = metrics.classification_report(y_true, y_pred, digits=4, target_names=target_names,
        ...
        report_dict = {
            "micro-f1-score": macro_f_score,
            "macro-f1-score": micro_f_score,
            "accuracy": accuracy_score
        }
        ...
        result = Result(
            ...
            detailed_results=detailed_result,
            metrics=report_dict.update(classification_report2)
        )
        return result, eval_loss
